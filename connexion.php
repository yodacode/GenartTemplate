			...
			<section class="tab-content">
				...
				<form name="form-artist" class="form-horizontal tab-pane fade active in" id="artist">
					<div id="nameArtist-control-group" class="control-group">
						...
						<div class="controls">
							...
							<span class="help-inline" style="display:none;" id="nameArtist-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="firstnameArtist-control-group" class="control-group">
						...
						<div class="controls">
							...
							<span class="help-inline" style="display:none;" id="firstnameArtist-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="mailArtist-control-group" class="control-group">
						...
						<div class="controls">
							...
							<span class="help-inline" style="display:none;" id="mailArtist-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="passwordArtist-control-group" class="control-group">
						...
						<div class="controls">
							...
							<span class="help-inline" style="display:none;" id="passwordArtist-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="passwordArtistConfirm-control-group" class="control-group">
						...
						<div class="controls">
							...
							<span class="help-inline" style="display:none;" id="passwordArtistConfirm-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="phoneArtist-control-group" class="control-group">
						...
						<div class="controls">
							...
							<span class="help-inline" style="display:none;" id="phoneArtist-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="websiteArtist-control-group" class="control-group">
						...
						<div class="controls">
							...
							<span class="help-inline" style="display:none;" id="websiteArtist-message"> lorem ipsum para bellum </span>
						</div>
					</div>
				...
				<form class="form-horizontal tab-pane fade " id="customer">
					<div id="-control-group" class="control-group">
						<label for="mailArtist" class="control-label">E-mail  * : </label>
						<div class="controls">
							<input data-error-selector="-message" type="text" id="mailArtist"  name="mailArtist" placeholder="vote-mail@mail.com"/>
							<span class="help-inline" style="display:none;" id="-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="-control-group" class="control-group">
						<label for="passwordArtist" class="control-label">Mot de passe  * : </label>
						<div class="controls">
							<input data-error-selector="-message" type="password" id="passwordArtist"  name="passwordArtist" placeholder="Mot de passe"/>
							<span class="help-inline" style="display:none;" id="-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<div id="-control-group" class="control-group">
						<label for="passwordArtistConfirm" class="control-label">Confirmation  * : </label>
						<div class="controls">
							<input data-error-selector="-message" type="password" id="passwordArtistConfirm"  name="passwordArtistConfirm" placeholder="Confirmation"/>
							<span class="help-inline" style="display:none;" id="-message"> lorem ipsum para bellum </span>
						</div>
					</div>
					<input type="submit" class="button red noborder pull-right" value="Inscription"/>
...
// nameArtist
            var validator = new FormValidator("form-artist",
                [
                    {
